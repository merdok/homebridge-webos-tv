...
class LgTvController extends EventEmitter {
  ...
  setPictureMode(pictureMode) {
    ...
    cinema, eco, expert1, expert2, game, normal, photo, sports,
    technicolor, vivid, hdrEffect,  hdrCinema, hdrCinemaBright, hdrExternal,
    hdrGame, hdrStandard, hdrTechnicolor, hdrVivid, dolbyHdrCinema,
    dolbyHdrCinemaBright, dolbyHdrDarkAmazon, dolbyHdrGame, dolbyHdrStandard,
    dolbyHdrVivid, dolbyStandard
    */
    let settings = {
      pictureMode: pictureMode
    }
    this.setSystemSettings(settings);
  }
