  ...
  async subscribeToPowerStatusChange() {
    return this.tvSubscribe(WEBOS_URI_POWER_STATE, null, (err, res) => {
      ...
      if (this.checkTvState() === 'Off' && statusProcessing === 'Request Suspend') {
        ...
        //this.disconnect();  MP 27.07.2020 - i moved this to the on close event above, this seem sto be better a place, but now the turned off event here is fired multiply times, investigate this
